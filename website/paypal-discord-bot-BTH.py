...
def embed_message(title, description):
    ...
    text.set_footer(text="BTH Bring The Heat |by CookStart.io", icon_url="https://cdn.discordapp.com/attachments/570671720093057106/572886431870091265/BTH_Robot.png")
    return text
