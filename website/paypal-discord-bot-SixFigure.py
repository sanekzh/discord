...
def embed_message(title, description):
    ...
    text.set_footer(text="SixFigure Sneakerhead | CookStart.io", icon_url="https://cdn.discordapp.com/attachments/568555204866474004/568807016802418724/image0.jpg")
    return text
